...
class ModeloRefraccionGeneral
{
	...
	static public function mdlIngresarRefraccionGeneral($tabla, $datos)
	{
        ...
        $stmt->bindParam(":tipo_lentes", $datos["tipo_lentes"], PDO::PARAM_STR);
	...
	static public function mdlMostrarRefraccionGeneral($tabla, $item, $item2, $valor, $valor2)
	{
	...
	static public function 	mdlMostrarRefraccionGeneralID($tabla, $item, $valor)
	{
