...
class ModeloTerapiasOptometriaNeonatos
{
	...
	static public function mdlIngresarTerapiaOptometriaNeonatos($tabla, $datos)
	{
	...
	/*=============================================
	MOSTRAR OPTOMETRIA NEONATOS
	=============================================*/

	static public function mdlMostrarTerapiaOptometriaNeonatos($tabla, $item, $valor)
	{
	...
	/*=============================================
	MOSTRAR OPTOMETRIA NEONATOS ID
	=============================================*/

	static public function mdlMostrarTerapiaOptometriaNeonatosID($tabla, $item, $valor)
	{
