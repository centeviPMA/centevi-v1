...
class ModeloOptometriaPediatrica

{
	...
	static public function mdlIngresarOptometriaPediatrica($tabla, $datos)

	{



		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(sucursal,doctor,paciente,id_terapia, edad, fecha_atencion, m_c, a_o,a_p, a_f, medicamentos, tratamientos, desarrollo ,nacimiento, parto, incubadora, tiempo ,av_sc, av_cc, lensometria, lensometria_extra, sa_pp, visuscopia , visuscopia_extra , refraccion , lentes_contacto , pruebas ,pruebas_extra, plan_versiones ,conducta_seguir, fecha_creacion ) VALUES (:sucursal,:doctor,:paciente, :id_terapia, :edad,:fecha_atencion, :m_c, :a_o, :a_p , :a_f, :medicamentos, :tratamientos,:desarrollo , :nacimiento, :parto, :incubadora, :tiempo, :av_sc , :av_cc , :lensometria, :lensometria_extra, :sa_pp, :visuscopia, :visuscopia_extra , :refraccion, :lentes_contacto, :pruebas ,:pruebas_extra, :plan_versiones, :conducta_seguir,  :fecha_creacion )");
		...
		$stmt->bindParam(":incubadora", $datos["incubadora"], PDO::PARAM_STR);
	...
	MOSTRAR CONSULTA OPTOMETRIA PEDIATRICA - FUNCION QUE FALTABA

	===================================================================================*/



	static public function mdlMostrarOptometriaPediatrica($tabla, $item, $item2, $valor, $valor2)
	...
	static public function mdlMostrarOptometriaPediatricaID($tabla, $item, $valor)
	...
	MOSTRAR CANTIDAD POR ID

	=============================================*/



	static public function mdlMostrarCantidadOptometriaPediatricaID($tabla, $item, $valor)
	...
	static public function mdlEditarConsultaOptometriaPediatrica($tabla, $datos)

	{



		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET sucursal = :sucursal, paciente = :paciente, edad = :edad, fecha_atencion = :fecha_atencion , m_c = :m_c, a_o = :a_o, a_p = :a_p , a_f = :a_f, medicamentos = :medicamentos, tratamientos = :tratamientos, desarrollo = :desarrollo , nacimiento = :nacimiento , parto = :parto , incubadora = :incubadora, tiempo = :tiempo , av_sc = :av_sc , av_cc = :av_cc, ojo_dominante = :ojo_dominante, mano_dominante =:mano_dominante, lensometria = :lensometria , lensometria_extra = :lensometria_extra , sa_pp = :sa_pp ,visuscopia =:visuscopia, visuscopia_extra = :visuscopia_extra , refraccion = :refraccion , lentes_contacto = :lentes_contacto , pruebas = :pruebas, pruebas_extra = :pruebas_extra , plan_versiones = :plan_versiones ,conducta_seguir = :conducta_seguir ,editado = :editado WHERE id_consulta = :id_consulta");
