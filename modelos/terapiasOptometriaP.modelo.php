...
class ModeloTerapiasOptometriaPediatrica
{
	...
	static public function mdlIngresarTerapiaOptometriaPediatrica($tabla, $datos)
	{
...
if ($executeResult) {
    ...
    return "Error: " . $errorInfo[2]; // Muestra el mensaje de error
}
	...
	/*=============================================
	MOSTRAR OPTOMETRIA Pediatrica
	=============================================*/

	static public function mdlMostrarTerapiaOptometriaPediatrica($tabla, $item, $valor)
	{
	...
	/*=============================================
	MOSTRAR OPTOMETRIA Pediatrica ID
	=============================================*/

	static public function mdlMostrarTerapiaOptometriaPediatricaID($tabla, $item, $valor)
	{
