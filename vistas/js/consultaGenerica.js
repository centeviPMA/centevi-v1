...
$(".btnVerConsulta").on("click", function(){
    ...
    window.location = "index.php?ruta=ver-consulta-generica&id_consulta="+id_consulta;
...
$(".btnEditarConsulta").on("click", function(){
  ...
  window.location = "index.php?ruta=editar-consulta-generica&id_consulta="+id_consulta+'&id_paciente='+id_paciente+'&id_terapia='+id_terapia;
