        ...
        <div class="widget-one">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
              <div class="widget widget-one">
                <div class="widget-heading">
                  <h6 class="">Reporte de pacientes atendidos por día</h6>
                </div>
                <div class="w-chart">
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
              <div class="widget-four">
                <div class="widget-heading">
                  <h5 class="">ULTIMOS PACIENTES ATENDIDOS POR DIA</h5>
                </div>
                ...
                <div class="table-responsive">
                  <table class="table dt-table-hover tabla_pacientes" style="width:100%">
                    ...
                    <tbody>
                      ...
                      $ultimosPacientes = ControladorReportes::ctrMostrarPacientesAtendidosPorDiaV2($valor, $fecha=null);
                      ...
                      foreach ($ultimosPacientes as $key => $value) {
                        ...
                        echo '<tr>
                                                   ...
                                                   <td>' . $value["PACIENTE_NOMBRE"] . ' ' . $value["PACIENTE_APELLIDO"] . '</td>
                                                   <td>' . $value["PACIENTE_CEDULA"] . '</td>
                                                   <td>' . $value["SUCURSAL"] . '</td>
                                                   <td>' . $value["PACIENTE_CELULAR"] . '</td>
          ...
          <div class="col-md-12">
            ...
            <div class="form-group col-md-4 mt-4">
                ...
                <input type="text" id="fecha_reporte" class="form-control" name="fecha" value="<?php echo $fecha ?>">
            ...
            <div class="table-responsive">
              <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                ...
                <tbody>
                  ...
                  $ultimosPacientes = ControladorReportes::ctrMostrarPacientesAtendidosPorDiaV2($valor=null, $fecha);


                    foreach ($ultimosPacientes as $key => $value2) {
                      $newfecha = new DateTime($value2["FECHA_ATENCION"]);

                      echo '<tr>
                                                         <td>' . $value2["PACIENTE_NOMBRE"] . ' ' . $value2["PACIENTE_APELLIDO"] . '</td>
                                                           <td>' . $value2["PACIENTE_CEDULA"] . '</td>
                                                           <td>' . $value2["SUCURSAL"] . '</td>
                                                           <td>' . $value2["PACIENTE_CELULAR"] . '</td>
                                                           <td>' . $value2["TIPO"] . '</td>
                                                           <td title="'.$value2["FECHA_ATENCION"].'">' . $newfecha->format('Y-m-d') . '</td>
                                                            <td>' . $value2["DOCTOR"] . '</td>
        ...
        $("#buscar").on("click", function() {
            ...
            if (fecha_reporte === "") {
                swal({
                    ...
                    if (result.value) {
                        window.location = "index.php?ruta=reporte-pacientes-atendidos-por-dia";
                    }
                });
            } else {
                window.location = "index.php?ruta=reporte-pacientes-atendidos-por-dia&fecha_reporte=" + fecha_reporte;
            }
        });
    });
</script>
