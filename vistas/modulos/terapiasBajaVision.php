                ...
                <div class="widget-one">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $terapia = ControladorTerapiasBajaVision::ctrMostrarTerapiaGeneralBajaVisionID($item, $valor);
                            ...
                            <form role="form" method="post">
                             ...
                             <?php
                              ...
                              $actualizarMotivo = new ControladorTerapiasBajaVision();
                              ...
                              ?>
                                ...
                                ?>
                                    ...
                                    $crearResultado = new ControladorConsultaBajaVision();
                                ...
                                <div class="card component-card_7" style="width:100%; background: rgb(0 150 136 / 11%);">
                                    <div class="table-responsive-md">
                                        ...
                                        <table id="zero-config" class="table dt-table-hover sesiones" style="width:100%">
                                            ...
                                            <?php
                                                ...
                                                $resultado = ControladorConsultaBajaVision::ctrMostrarTerapia($item, $valor);
                                                ...
                                                foreach ($resultado as $key => $value) {
                                                    ...
                                                    $sesion = json_decode($value['sesion'], true);
                                                    ...
                                                    // $sesiones = ControladorConsultaBajaVision::ctrMostrarTerapiaIndividual($item1, $valor1);
                                                ...
                                                echo '<td style="width: 220px">
                                                    <select required class="form-control" id="sucursal" name="sucursal" idSesion="'.$value["id"].'"  idTerapia="'.$_GET["id_terapia"].'" idPaciente="'.$_GET["id_paciente"].'">
                                                ...
                                                echo '
                                                  ...
                                                  echo '<td>'.$value['fecha_creacion'].'</td>';
                                                    ...
                                                    echo '<button ver_terapia="' . $value['id'] . '"  id_paciente="' . $_GET['id_paciente'] . '"  id_terapia="' . $_GET['id_terapia'] . '" class="btnVerTerapia btn btn-primary mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                          </svg></button>
                                                          
                                                         <button    idSucursal="'.$value["sucursal"].'"       editar_terapia="' . $value['id'] . '" id_paciente="' . $_GET['id_paciente'] . '"  id_terapia="' . $_GET['id_terapia'] . '" class="btnEditarTerapia btn btn-warning mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                            </svg></button>';

                                                    if ($_SESSION['perfil'] == 'Administrador' || $_SESSION['perfil'] == 'superadministrador') {

                                                        echo '<button eliminar_terapia="' . $value['id'] . '" id_paciente="' . $_GET['id_paciente'] . '" id_terapia="' . $_GET['id_terapia'] . '" class="btnEliminarTerapia btn btn-danger mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    $borrar_terapia = new ControladorConsultaBajaVision();
                                ...
                                ?>
                                    <form role="form" method="post">
                                        ...
                                        $evaluación = ControladorTerapiasBajaVision::ctrMostrarTerapiaGeneralBajaVisionID($item, $valor);
                                    ...
                                    $actualizarEvaluacion = new ControladorConsultaBajaVision();
                                    $actualizarEvaluacion->ctrEditarEvaluacionBV();
