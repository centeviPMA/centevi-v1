                ...
                <div class="table-responsive">
                  <table class="table dt-table-hover tabla_pacientes" style="width:100%">
                    ...
                    <tbody>
                      ...
                      $ultimosPacientes = ControladorReportes::ctrMostrarPacientesAtendidosPorDia($valor, $fecha=null);
            ...
            <div class="table-responsive">
              <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                ...
                <tbody>
                  ...
                  $ultimosPacientes = ControladorReportes::ctrMostrarPacientesAtendidosPorDia($valor=null, $fecha);
