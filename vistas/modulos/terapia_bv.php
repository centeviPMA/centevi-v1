                  ...
                  <div class="col-md-12">
                     <div class="widget-content widget-content-area">
                           ...
                           <form role="form" method="post">
                              <div class="form-row mb-4">
                                 <div class="form-group col-md-12">
                                    ...
                                    <textarea id="textarea" class="form-control textarea" maxlength="800" rows="4" placeholder="Esta área tiene un limite de 800 caracteres." name="actividad"></textarea>
                                 </div>
                              </div>
                              <div class="form-row mb-4">
                                 <div class="form-group col-md-12">
                                    <label>Resultado</label>
                                    <textarea id="textarea" class="form-control textarea" maxlength="800" rows="4" placeholder="Esta área tiene un limite de 800 caracteres." name="resultado"></textarea>
                                 </div>
                              </div>
                        ...
                        <?php } else if (isset($_GET['editar_terapia'])) {  ?>
                           ...
                           $resultado = ControladorConsultaBajaVision::ctrMostrarTerapiaIndividual($item, $valor);
                           ...
                           $crearResultado = new ControladorConsultaBajaVision();
                           $crearResultado->ctrEditarTerapia();
