terapiasOptometriaNeonatos.php
                ...
                <div class="widget-one">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $terapia = ControladorTerapiasOptometriaNeonatos::ctrMostrarTerapiaOptometriaNeonatosID($item, $valor);
                            ...
                            <form role="form" method="post">
                             ...
                             <?php
                              ...
                              $actualizarMotivo = new ControladorTerapiasOptometriaNeonatos();
                              ...
                              ?>
                                ...
                                ?>
                                    ...
                                    <?php
                                     ...
                                     $crearResultado = new ControladorOptometriaNeonatos();
                                ...
                                <div class="card component-card_7" style="width:100%; background: rgb(0 150 136 / 11%);">
                                    <div class="table-responsive-md">
                                        ...
                                        <table id="zero-config" class="table dt-table-hover sesiones" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $resultado = ControladorOptometriaNeonatos::ctrMostrarTerapia($item, $valor);
                                                ...
                                                foreach ($resultado as $key => $value) {
                                                   ...
                                                   echo '<td>'.$value['fecha_creacion'].'</td>';
                                                    ...
                                                    echo '<button ver_terapia="' . $value['id'] . '"  id_paciente="' . $_GET['id_paciente'] . '"  id_terapia="' . $_GET['id_terapia'] . '" class="btnVerTerapiaOPN btn btn-primary mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                          </svg></button>
                                                          <button editar_terapia="' . $value['id'] . '" id_paciente="' . $_GET['id_paciente'] . '"  id_terapia="' . $_GET['id_terapia'] . '" class="btnEditarTerapiaOPN btn btn-warning mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                          </svg></button>';

                                                    if ($_SESSION['perfil'] == 'Administrador' || $_SESSION['perfil'] == 'superadministrador') {

                                                        echo '<button eliminar_terapia="' . $value['id'] . '" id_paciente="' . $_GET['id_paciente'] . '" id_terapia="' . $_GET['id_terapia'] . '" class="btnEliminarTerapiaOPN btn btn-danger mb-2 p-1 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    $borrar_terapia = new ControladorOptometriaNeonatos();
                                ...
                                $cantidad_citas = ControladorOptometriaNeonatos::ctrMostrarCantidadOptometriaNeonatosID($item_cantidad, $valor_cantidad);
                                ...
                                ?>
                                    <form role="form" method="post">
                                        ...
                                        $evaluación = ControladorTerapiasOptometriaNeonatos::ctrMostrarTerapiaOptometriaNeonatosID($item, $valor);
                                    ...
                                    $actualizarEvaluacion = new ControladorOptometriaNeonatos();
                                    $actualizarEvaluacion->ctrEditarEvaluacionON();
...
<script src="vistas/js/optometriaNeonatos.js"></script>